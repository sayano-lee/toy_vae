...
class Encoder(nn.Module):
    ...
    def __init__(self, nc, ndf, nlatent):
        ...
        self.conv7 = nn.Conv2d(ndf*16, nlatent, kernel_size=8, stride=1, padding=0, bias=False)
...
class Decoder(nn.Module):
    ...
    def __init__(self, nc, ngf, nlatent):
        ...
        self.deconv1 = nn.ConvTranspose2d(nlatent, ngf*16, kernel_size=8, stride=1, padding=0, bias=False)
